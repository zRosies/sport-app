...
export default function Header() {
  ...
  return (
    ...
    <header className="flex gap-5 justify-between w-full border-2 border-red-500">
      ...
      <Link href={"/login"} className="justify-center px-6 py-3 my-auto rounded-2xl bg-teal-700 bg-opacity-90 max-md:px-5">
        Entrar
      </Link>
    </header>
  );
