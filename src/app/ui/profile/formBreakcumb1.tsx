    ...
    <>
      <div
        className={` duration-300 ${
          translateX && " absolute  translate-x-[400px]"
        }  w-[330px] md:w-[360px] gap-2 flex flex-col bg-white p-2`}
      >
      ...
      <p
        ...
        className="flex hover:scale-105 duration-200 gap-1 items-center self-end cursor-pointer my-2 text-green-600"
      >
