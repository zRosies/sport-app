...
const FormBreadcumb2 = ({
  ...
  return (
    <>
      <div
        className={`absolute top-2 duration-300 ${
          translateX ? " absolute translate-x-0" : " translate-x-[-400px]"
        } w-[330px] md:w-[360px] gap-2 flex flex-col p-2 bg-white  `}
      >
        ...
        <p
          ...
          className="text-green-600 flex gap-1 hover:scale-105 duration-200 items-center cursor-pointer my-2 text-start self-start"
        >
          {" "}
          <IoIosArrowBack /> Retornar
        </p>
      </div>
    </>
  );
